...
def test_turn_cw(hero, game_hvsp):
    ...
    _turn_cw.activate()
    assert game_hvsp.battlefield.unit_facings[hero] == Facing.EAST
    _turn_cw.activate()
    assert game_hvsp.battlefield.unit_facings[hero] == Facing.SOUTH
    _turn_cw.activate()
    assert game_hvsp.battlefield.unit_facings[hero] == Facing.WEST
    _turn_cw.activate()
    assert game_hvsp.battlefield.unit_facings[hero] == Facing.NORTH
