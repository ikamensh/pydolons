...
def test_different_units(hero, pirate):
    atm = AtbTurnsManager([hero, pirate])
...
def test_readiness_defines_turn(hero, pirate):
    atm = AtbTurnsManager([hero, pirate])
...
def test_cycles_well(hero, pirate):
