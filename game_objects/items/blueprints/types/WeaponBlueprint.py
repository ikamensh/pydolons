...
from game_objects.items.blueprints.types.WeaponTypes import damage_type_from_weapon_type, mastery_from_weapon_type
...
class WeaponBlueprint(Blueprint):
    ...
    def __init__(self, name, *, target_item_type, material_type, rarity,
        ...
        self.mastery = mastery_from_weapon_type[target_item_type]
    ...
    def to_item(self, material, quality):
        ...
        return Weapon(full_name, damage, durability, mastery=self.mastery, blueprint=self, material=material,
                      quality=quality)
