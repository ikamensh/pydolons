...
class WeaponTypes:
    ...
    BOW = WeaponType(d.PIERCE, m.BOW, ImpactChances(0.02, 0.25, 0.25))
    CROSSBOW = WeaponType(d.PIERCE, m.SHOOT, ImpactChances(0.02, 0.25, 0.25), damage_factor=1.5, atb_factor=2.1)
